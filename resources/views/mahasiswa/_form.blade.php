...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <select id="jenis_kelamin" name="jenis_kelamin"
            ...
            <option value="Laki-laki" {{ old('jenis_kelamin', $mhs->jenis_kelamin ?? '') == 'Laki-laki' ? 'selected' : '' }}>
                Laki-laki
            </option>
            <option value="Perempuan" {{ old('jenis_kelamin', $mhs->jenis_kelamin ?? '') == 'Perempuan' ? 'selected' : '' }}>
                Perempuan
            </option>
        </select>
    ...
    <div>
        ...
        <x-text-input id="program_studi" name="program_studi" type="text" class="mt-1 block w-full"
            value="{{ old('program_studi', $mhs->program_studi ?? '') }}" required />
    ...
    <div class="md:col-span-2">
        ...
        <textarea id="alamat" name="alamat" rows="3"
            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500">{{ old('alamat', $mhs->alamat ?? '') }}</textarea>
